...
Üçüncüsü: **Anthropic vision olgun durumda** — Claude Sonnet 4.5 vision quality GPT-4o ile yarışır seviyede. Bu sayfada Anthropic-first yaklaşımımızla tutarlı kalıyoruz.
...
- **Per request:** 100 image (Claude Sonnet 4.5); token bütçesi karar verir
...
- **Claude Sonnet 4.5 (2025):** Vision + tool use tam olgunluk
