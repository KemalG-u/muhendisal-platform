...
!!! tip "Yabancı kelime mi gördün?"
    **Engagement** = LinkedIn/X'te post'una gelen like/yorum/paylaşım sayısı. **Reach** (erişim) = post'unu gören kullanıcı sayısı (follower + algoritmanın yaydığı). **Lateral mover** = farklı meslekten AI Engineer'a geçiş yapan kişi (backend dev, avukat, öğretmen vb.). **DM** (direct message) = doğrudan mesaj, post/profil yerine özel iletişim. **Creator mode** = LinkedIn'in yazar/içerik üretici moduna geçiş; followers görünür olur. **InMail** = LinkedIn Premium'la tanımadığın kişiye mesaj.
...
## LinkedIn 2026 — algoritma ve keyword

### Algoritma ne seviyor (2026 güncel)

LinkedIn 2026 algoritması 3 şeyi ölçer:

1. **Dwell time** — post'una bakan kişi ne kadar kalıyor? Uzun metinler (200-500 kelime) kısa metinlerden daha iyi.
2. **Erken engagement** — ilk 30 dakikada 10+ etkileşim → algoritma daha çok insana gösterir.
3. **Yorum kalitesi** — 5 kelimelik "Harika!" yerine 30 kelimelik yorumlar → premium sinyal.

**Pratik:**
- Pazartesi-Çarşamba 08:00-10:00 TR saati → Türkçe AI topluluğunun en aktif zamanı.
- Post'u yazdıktan sonra ilk 30 dk **kendin** 3-5 yorum cevaplarsın.
- Network'ünden 2-3 arkadaşa "yorum atar mısın?" de — ilk ivme.

### ATS keyword derinleşmesi

9.7'de 10 skill seçtik. LinkedIn ATS + recruiter taraması için **Profile'ın her yerine** yerleştirilecek 20 keyword listesi:

<table class="ma-aktorler" markdown>

| Kategori | Keyword'ler (her biri farklı yerde görünmeli) |
|---|---|
| **Core AI** | AI Engineer · LLM · RAG · Claude · Anthropic · Prompt Engineering · Agent Systems · MCP · Tool Calling |
| **Stack** | Python · FastAPI · Qdrant · Vector Database · Embeddings · Docker · PostgreSQL |
| **Production** | Deployment · CI/CD · Monitoring · Observability · Cost Optimization |
| **Safety** | AI Safety · Constitutional AI · Prompt Injection · Bias Audit · KVKK / GDPR |
| **Soft** | Technical Writing · Turkish-English Technical · Open Source · Self-directed Learning |

</table>

**Nereye koyulur:**

- **Headline:** En güçlü 3 keyword (AI Engineer + Claude + RAG)
- **About (yukarıdan aşağı):** 10-15 keyword doğal akışta
- **Experience (her job):** Her pozisyon açıklamasında 3-5 keyword
- **Skills:** 10-15 explicit skill (eski 10 + 5 yeni)
- **Featured:** 2-3 proje, her biri keyword-yoğun açıklama
- **Recommendations (iste):** Eski iş arkadaşından bir "Python + Claude ile ... kurdu" recommendation

**Keyword stuffing uyarısı:** Aynı kelimeyi 20 kez yazmak ters etki. 20 keyword = her biri 2-4 kez, doğal bağlamda. Recruiter "okuyunca doğal" hissedecek; ATS "eşleşme yüksek" sinyal alacak.
...
### Hafta 4 — Araç/Library karşılaştırma (SEO magnet)

**Başlık:** "Qdrant vs Pinecone 2026 — self-host + 1M vektör senaryosu"
**İçerik:** 3.3 sayfasının özetlenmiş versiyonu. Benchmark + fiyat + karar matrisi.
...
Klasik yol: LinkedIn'de ilana başvur → 2000 başvuru arasında kaybol. **Alternatif yol** (2025-2026'da daha etkili):

1. Hedef 10-20 şirket belirle — ilgilendiğin AI odaklı Türkiye/remote şirketler.
2. Her şirketten **hiring manager** veya CTO bul. LinkedIn search → "AI" + "[Şirket]" + "founder" / "CTO" / "Head of AI".
3. **3 cümlelik mesaj at** (9.7'deki şablon):
    - Şirkete özel 1 cümle (ürününü beğendim, şu feature'ı kullanıyorum vb.)
    - Portföy link + 1 cümle ne yaptığın
    - Net aksiyon (20 dk görüşme)
...
- İlan tabanlı başvuru: %2-5 ilk görüşme daveti
- DM tabanlı başvuru: %15-25 ilk görüşme daveti (yüksek kalite target + özenli mesaj)

**Uyarı:** DM iş başvurusu zaman alır — **her mesajı ayrı araştır ve yaz**. Aynı mesajı 50 kişiye kopyala-yapıştır = LinkedIn spam flag, hesap restriction.

**Günlük kontingent:** 3-5 yüksek kalite DM. 1 saat sürer. Haftada 20-25 DM → ayda 80-100 DM → 15-25 ilk görüşme daveti realistik beklenti.

## Creator mode + personal brand

LinkedIn Creator Mode aktif et:

1. Profil sayfana gir → Resources → "Creator Mode: Off" tıkla, **On** yap.
2. İlk 5 topic seç: `AI Engineering`, `Claude`, `LLMs`, `RAG`, `Python`.
3. Followers görünür olur (Connections değil, Followers sayısı). Bir recruiter için "bu adamın sesi var" sinyali.

**3 ay sonra hedef:** 300-500 followers + haftada 1 post. 6 ay sonra 1000-2000 followers mümkün.
...
### Anthropic Careers (doğrudan)

[Anthropic Careers](https://www.anthropic.com/careers) — 2026'da aktif işe alım:
- **Applied AI Engineer:** Claude'u müşteri ürünlerine entegre etme. 1.2'de "AI Engineer" olarak tanımlanan rol.
- **Technical Staff:** Platform + API geliştirme.
- **Solutions Engineer:** Enterprise müşterilerine entegrasyon.

Türkiye'den remote — pozisyona bağlı. Çoğu ABD/UK/AB tabanlı ama remote açık pozisyonlar var.

**Profil gereksinimi (gerçekçi):**
- 3+ yıl production Python/backend
- LLM integration tecrübesi (ideali Claude)
- Strong portfolio (senin 2 proje **yeterli değil başlangıç için**, 4-5 canlı proje + katkılar birikimi)
- İngilizce akıcı

Senin için **1-2 yıllık bir hedef.** Şimdi başvurma — önce birikim + 1-2 yıl şirket tecrübesi. Sonra Anthropic'e geçiş güçlü.

### Anthropic Ambassador programı

Anthropic'in topluluk elçi programı var (geçici adıyla "community ambassador"). Seçilmiş kullanıcılar:
- Erken beta erişim
- Anthropic etkinliklerinde sunum fırsatı
- Bir "topluluk yöneticisi" role — AI haberleri yayma, kendi ülkesinde etkinlik

Başvuru: Anthropic sosyal medyasında açık çağrıları takip et. Resmi URL henüz stabil değil — 2026 ilerleyen ay/çeyrek duyurular çıkabilir.
...
## CTO tuzakları — 10 LinkedIn hatası

| # | Tuzak | Sonuç | Doğru |
|---|---|---|---|
| 1 | Profil statik, 6 ay post yok | "Atlatılmış" sinyal | Haftada 1 post minimum |
| 2 | Keyword stuffing | Robot metin, red | 20 keyword doğal bağlamda |
| 3 | Aynı DM 50 kişiye | Spam flag, hesap restriction | Her DM özel, günde 3-5 |
| 4 | "Açık kaynak" Featured'da proje yok | Credibility zayıf | 2-3 proje pin + description |
| 5 | Creator Mode kapalı | Followers görünmez, otorite yok | Aç, 5 topic seç |
| 6 | Headline "Software Dev @ X" | AI arama dışı | "AI Engineer \| Claude + RAG \| Şehir" |
| 7 | Engagement yok post sonrası | Algoritma boğar | İlk 30 dk kendin yorumla + arkadaşlara haber |
| 8 | About 500+ kelime | Okunmaz | 150-300 kelime, 3-4 paragraf |
| 9 | Türkçe only | Global fırsat kaçar | TR ağırlık + EN mini özet |
| 10 | Follow Anthropic yok | Haber kaçar, yorum fırsatı | Anthropic + OpenAI + Google AI takip |
...
### Saat 1 — Pozisyon kararı + LinkedIn update

1. 4 profilden hangisisin? Yazılı karar.
2. Headline revize: "AI Engineer \| Python + Claude + RAG \| Şehir".
3. About 150-300 kelime, 20 keyword'ün ilk 10'unu doğal yerleştir.
4. Skills: 10'dan 15'e çıkar. Yeni ekleler: Prompt Injection · AI Safety · Constitutional AI · Türkçe Teknik Yazım · Cost Optimization.
5. Creator Mode aç, 5 topic seç.
...
### Saat 3 — DM hedefleri + Anthropic ekosistem takip

1. 10 hedef şirket belirle — Türkiye + remote AI odaklı.
2. Her şirketten 1 hiring manager / CTO profil kaydet.
3. Anthropic + OpenAI + Google AI LinkedIn follow.
4. 6 haftalık post takvimini `muhendisal-notlarim/bolum-10/icerik-plani.md`'ye kaydet.
5. 1. DM'yi yaz, Çarşamba 10:00 gönder.
