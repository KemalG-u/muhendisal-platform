...
Anthropic [Model Spec](https://platform.claude.com/docs/en/docs/model-spec) yayınladı: "Claude şu durumlarda şunu yapar, şunu yapmaz" detaylı liste. Açık kaynak, herkes okur.
...
**Kaynak:**
- [Model Spec](https://platform.claude.com/docs/en/docs/model-spec)
...
**Pekiştirme:** [AI Act resmi metin](https://artificialintelligenceact.eu/) + [Anthropic Model Spec](https://platform.claude.com/docs/en/docs/model-spec) + [Constitutional AI paper](https://arxiv.org/abs/2212.08073). Üçünü 2 saat ayır, etik AI mimarisi kavramı netleşir.
</div>
